...
class Home extends React.Component {
    ...
    if(element==id){
        document.getElementById(element).style.background="linear-gradient(206.27deg, #368C9F 15.28%, rgba(42, 66, 141, 0) 68.37%)";
    }else{
          ...
          <div class="col-md-8">
            ...
            <div class="contact-us">
              ...
              <div
                ...
                data-aos-delay="1200"
              >
                <a class="a-btn" target="_blank" href="/contact">Contact Us</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row point">
              ...
              <div class="col-10">
                <div
                  ...
                  data-aos-delay="800"
                >
                  <span>30%</span> of the exchange fees goes to our affiliate
                  program instead of spending it on expensive Marketing
                  campaigns with very little return!
                </div>
              </div>
            </div>
            <div class="row point">
              ...
              <div class="col-10">
                <div
                  ...
                  data-aos-delay="1200"
                >
                  <span>20%</span> of exchange fees goes to the company to cover
                  operations costs.
                </div>
              </div>
            </div>
        ...
        <div class="row try">
          <div class="col text-center">
            <div data-aos="flip-left" data-aos-duration="800">
              <a class="a-btn" target="_blank" href="/try">Let’s Try</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            ...
            >
              ...
              <div class="feature-desc">
                ...
                tangible asset. Historical Coins such as BTC and ETH will be the
                only assetless coin be listed.
              </div>
            </div>
          </div>
          <div class="col-md-5">
            ...
            >
              ...
              <div class="feature-desc">
                Flash offers a suite of order types to give traders the tools
                they need for every scenario. Discover more about our most
                advanced Algoritmic orders types.
              </div>
            </div>
          </div>
          <div class="col-md-5">
            ...
            >
              ...
              <div class="feature-desc">
                ...
                layout, choose between themes, set up notifications and data
                preferences.
              </div>
            </div>
          </div>
          <div class="col-md-5">
            ...
            >
              ...
              <div class="feature-desc">
                ...
                Contact us to know more about our security features and
                integrations.
              </div>
            </div>
          </div>
          <div class="col-md-5">
            ...
            >
              ...
              <div class="feature-desc">
                Join our Growing global community that believes in the power of
                Cryptocurrency link to tangible asset.
              </div>
            </div>
          </div>
          <div class="col-md-5">
      ...
      <div class="container">
        <div class="row d-md-none d-block">
          <div class="col-sm-12 mb-2">
            <h2 data-aos="fade-up" data-aos-duration="1200">Stable Coin</h2>
          </div>
        </div>
          ...
          <div class="col-md-6 my-auto">
            ...
            <div class="point row">
              ...
              <span
                ...
                value of the grain, which is a subdivision of the gold metric
                (therefore linked indirectly with gold collateral).</span
              >
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 intro">
            <div>
              <h2 data-aos="fade-up" data-aos-duration="1200">OZTG Package</h2>
            </div>
            <div
              data-aos="fade-up"
              data-aos-duration="1200"
        ...
        <div class="row">
          <div class="col-md-3" >
            <div data-aos="fade-up" id="Standard" data-aos-duration="1200" class="package">
              <div class="row">
              ...
              <div class="row mt-2">
                <span class="rate col-4 col-md-12 yearprofit ">869.31%</span>
                <span class="rate col-6 col-md-12 price">0.137</span>

                <span class="col-2 col-md-12 p-0 select-btn">
                  <span onClick={() => this.selectpack("Standard")} class="d-none d-md-block select mt-3">Select</span>
          ...
          <div class="col-md-3" >
            ...
            >
              ...
              <div class="row mt-2">
                <span class="rate col-4 col-md-12 yearprofit ">874.06%</span>
                <span class="rate col-6 col-md-12 price">0.137</span>

                <span class="col-2 col-md-12 p-0 select-btn">
                  <span onClick={() => this.selectpack("Premium")}  class="d-none d-md-block select mt-3">Select</span>
                  <span class="d-block d-md-none select mt-2 mr-0"
                    ><img
                      class="mt-3"
                      src="https://res.cloudinary.com/dmeppscpx/image/upload/v1619814212/flashxchanger/select_braxnn.svg"
          ...
          <div class="col-md-3" >
            ...
            >
              ...
              <div class="row mt-2">
                <span class="rate col-4 col-md-12 yearprofit ">885.91%</span>
                <span class="rate col-6 col-md-12 price">0.137</span>

                <span class="col-2 col-md-12 p-0 select-btn">
                  <span onClick={() => this.selectpack("Gold")} class="d-none d-md-block select mt-3">Select</span>
                  <span class="d-block d-md-none select mt-2 mr-0"
                    ><img
                      class="mt-3"
                      src="https://res.cloudinary.com/dmeppscpx/image/upload/v1619814212/flashxchanger/select_braxnn.svg"
          ...
          <div class="col-md-3">
            ...
            >
              ...
              <div class="row mt-2">
                <span class="rate col-4 col-md-12 yearprofit ">902.50%</span>
                <span class="rate col-6 col-md-12 price">0.137</span>

                <span class="col-2 col-md-12 p-0 select-btn">
                  <span onClick={() => this.selectpack("Elite")} class="d-none d-md-block select mt-3">Select</span>
                  <span class="d-block d-md-none select mt-2 mr-0"
                    ><img
                      class="mt-3"
                      src="https://res.cloudinary.com/dmeppscpx/image/upload/v1619814212/flashxchanger/select_braxnn.svg"
          ...
          <div class="col-md-6 d-flex">
            <div class="trade-desc my-auto">
              ...
              >
                ...
                power of Flash cryptocurrency exchange in the palm of your hand.
              </div>
              <div class="mt-3">
                <a
                  data-aos="zoom-in"
